    ...
    <v-container>
        ...
        <template v-else>
                ...
                <v-layout justify-center align-center fill-height>
                    ...
                    <v-card flat class="card mx-auto py-5" max-height="600">
                        ...
                        <v-card-text>
                            ...
                            <p class="font-weight-bold primary--text pt-4 mb-0">You can't do self-review because you're currently on execution phase</p>
                        </v-card-text>
            ...
            <!-- check if user has done self-review before -->
                <template v-if="userSelfReviewData.length > 0">
                    <v-layout justify-center align-center fill-height>
                        <v-flex xs11>
                        <v-card flat class="card mx-auto py-5" max-height="600">
                            <v-img :src="require('@/assets/finish.svg')" contain aspect-ratio="4" ></v-img>
                            <v-card-text>
                                <p class="font-weight-bold primary--text pt-4 mb-0">You have completed your self-review for this term</p>
                            </v-card-text>
                            <v-btn color="accent" round class="px-5 mb-4" :to="{ name: 'my-okr' }">GO TO MY OKR</v-btn>
                        </v-card>
                        </v-flex>
                ...
                <template v-else>
                    <v-layout column>
                        ...
                        <v-layout shrink align-center column>
                            ...
                            <p class="text-xs-left mt-4">How was your performance for this term?</p>
                            <v-flex>
...
export default {
    ...
    methods: {
        ...
        changeState : function() {
            this.addSelfReview()
            this.modalTitle = 'Save Self Review',
            this.modalText = 'Your self-review has been saved',
            this.modalType = 'notification-success',
            this.$refs.modal.changeModalState();
            setTimeout(() => {
                this.$router.go("/self-review");
            }, 700);
        },
    ...
    async mounted() {
        try {
            ...
            const createdReview= await this.$axios.get(`/api/review/get/self-review/${this.getAuthUserId}`)
